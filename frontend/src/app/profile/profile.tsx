        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-gray-900 rounded-2xl w-full max-w-md border border-gray-700">
                ...
                <div className="p-4 space-y-4">
                    ...
                    <button onClick={handleSubmit} className="w-full py-3 bg-blue-600 text-white rounded-xl font-medium hover:bg-blue-500 transition-colors">
                        Update Level
                    </button>
                </div>
            </div>
...
export default function Profile() {
    ...
    if (!isConnected) {
        return (
            <div className="w-full text-center p-10 bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-2xl">
        ...
        <div className="w-full space-y-6">
            ...
            <div className="bg-gray-800/80 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 space-y-6">
                ...
                <div className="text-center">
                    ...
                    <p className="text-lg font-mono text-white">{formatWalletAddress(address)}</p>
                ...
                <div className="grid grid-cols-1 gap-4">
                    <div className="bg-gray-700/50 rounded-xl p-4 text-center">
                        ...
                        <p className="text-xs text-gray-500">{balanceData?.symbol}</p>
                    </div>
                    ...
                    <div className="bg-gray-700/50 rounded-xl p-4">
                        <div className="flex items-center justify-between mb-2">
                            ...
                            <button onClick={() => setIsModalOpen(true)} className="p-1.5 bg-blue-600 hover:bg-blue-500 rounded-lg transition-colors">
